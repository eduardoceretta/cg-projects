...
#ifndef P3D_SHAPE_HEX20_H
#define P3D_SHAPE_HEX20_H
...
/********************************************
  class P3DShapeHEX20
  Quadratic Serendipity rectangular prism.
*********************************************/
class POS3DLIB_API P3DShapeHEX20 : public P3DShape
{
public:
  typedef P3DShape SuperClass;

  P3DShapeHEX20();
  virtual ~P3DShapeHEX20();
