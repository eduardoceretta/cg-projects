...
#ifndef P3D_SHAPE_WEDGE6_H
#define P3D_SHAPE_WEDGE6_H

#include <pos3dlib/defines.h>
#include "../shape.h"

/********************************************
  class P3DShapeWEDGE6
  Linear serendipity triangular prism (wedge)
*********************************************/
class POS3DLIB_API P3DShapeWEDGE6 : public P3DShape
{
public:
  typedef P3DShape SuperClass;

  P3DShapeWEDGE6();
  virtual ~P3DShapeWEDGE6();
