/**
* Modulo de definicao da classe TpvProperty, para ser usado como propriedades para a TopsView
*/

#ifndef TPV_PROPERTY_H
#define TPV_PROPERTY_H
...
/**
  class TpvProperty
    ...
    Represents field result data associated to a model.
*/
class TpvProperty
{
public:
  ...
  */
  float* GetValue(int gid, int lid=0) const
  {
    int inc;
    gid -= m_base_gid;
    // Indirection is required for PROP_ELEMENT_NODE
