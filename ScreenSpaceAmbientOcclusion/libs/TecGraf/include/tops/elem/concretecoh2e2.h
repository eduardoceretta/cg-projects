...
private:
  ...
  TopNode      m_nodes[4];
  TopElement   m_adj[2];
  unsigned char m_rev[2];

protected:
  TopConcreteCOH2E2() {}

  TopNode* GetNodesArray() { return m_nodes; }
  TopElement* GetAdjArray() { return m_adj; }
  unsigned char* GetRevAdjArray() { return m_rev; }
