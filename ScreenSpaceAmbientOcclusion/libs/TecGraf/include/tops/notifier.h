...
public:
  ...
  */
  ...
  void NotifySplitEdge(TopEdge old_e, TopEdge new_e[2])
  {
    if (m_enabled)
      for (int i = 0; i < m_edit_listeners.Size(); i++)
        m_edit_listeners.Get(i)->SplitEdge(m_model, old_e, new_e);
  }
  void NotifySwapEdge(TopEdge old_e, TopEdge new_e)
  {
    if (m_enabled)
      for (int i = 0; i < m_edit_listeners.Size(); i++)
        m_edit_listeners.Get(i)->SwapEdge(m_model, old_e, new_e);
  }
  void NotifyMergeEdge(TopEdge old_e[2], TopEdge new_e)
  {
    if (m_enabled)
      for (int i = 0; i < m_edit_listeners.Size(); i++)
        m_edit_listeners.Get(i)->MergeEdge(m_model, old_e, new_e);
  }
...
//TODO review semantics
  //void NotifyInsertVertex(TopVertex v)
  //{
  //  if (m_enabled)
  //    for (int i = 0; i < m_edit_listeners.Size(); i++)
  //      m_edit_listeners.Get(i)->InsertVertex(m_model, v);
  //}
  //void NotifyInsertEdge(TopEdge new_e)
  //{
  //  if (m_enabled)
  //    for (int i = 0; i < m_edit_listeners.Size(); i++)
  //      m_edit_listeners.Get(i)->InsertEdge(m_model, new_e);
  //}
  //void NotifyRemoveVertex(TopVertex v)
  //{
  //  if (m_enabled)
  //    for (int i = 0; i < m_edit_listeners.Size(); i++)
  //      m_edit_listeners.Get(i)->RemoveVertex(m_model, v);
  //}
  //void NotifyRemoveEdge(TopEdge e)
  //{
  //  if (m_enabled)
  //    for (int i = 0; i < m_edit_listeners.Size(); i++)
  //      m_edit_listeners.Get(i)->RemoveEdge(m_model, e);
  //}
  void NotifyJoinFacet(TopFacet f1, TopFacet f2)
  {
    if (m_enabled)
      for (int i = 0; i < m_edit_listeners.Size(); i++)
