...
public:
  ...
  */
  bool SetData (int width, unsigned int format, unsigned int type, void *data, bool takeownership=false, bool border=false, bool isopaque=true);
  /**
   ...
   * 'takeownership' specifies if the data pointer can be used directly. if true, memory must have been allocated with m/calloc.
   */
  bool SetData (int width, int height, unsigned int format, unsigned int type, void *data, bool takeownership=false, bool border=false, bool isopaque=true);
  /**
   ...
   * 'takeownership' specifies if the data pointer can be used directly. if true, memory must have been allocated with m/calloc.
   */
  bool SetSubData (int xoffset, int yoffset, int width, int height, unsigned int format, unsigned int type, void *data);
  /**
   ...
   * 'takeownership' specifies if the data pointer can be used directly. if true, memory must have been allocated with m/calloc.
   */
  bool SetData (int width, int height, int depth, unsigned int format, unsigned int type, void *data, bool takeownership=false, bool border=false, bool isopaque=true);
  void CopyImage (int dim, unsigned int format, int x, int y, int w, int h);
  const void* GetData ();
  /**
