...
#ifndef P3D_SHAPE_COH2E3_H
#define P3D_SHAPE_COH2E3_H

#include <pos3dlib/defines.h>
#include "../shape.h"

/********************************************
  class P3DShapeCOH2E3
  Two-dimensional quadratic interface element.
  @verbatim  
     n3------n5------n4
  ...
  @endverbatim
*********************************************/
class POS3DLIB_API P3DShapeCOH2E3 : public P3DShape
{
public:
  typedef P3DShape SuperClass;

  P3DShapeCOH2E3();
  virtual ~P3DShapeCOH2E3();
