...
#ifndef P3D_SHAPE_INF3Q4_H
#define P3D_SHAPE_INF3Q4_H

#include <pos3dlib/defines.h>
#include "../shape.h"

/*************************************************************************
  class P3DShapeINF3Q4

  Represents the 8-node three-dimensional Serendipity isoparametric single 
  infinite element.
  ...
  Additional (related) refs.:
    ...
    pp. 371-379
**************************************************************************/
class POS3DLIB_API P3DShapeINF3Q4 : public P3DShape
{
public:
  typedef P3DShape SuperClass;

  P3DShapeINF3Q4();
  virtual ~P3DShapeINF3Q4();
